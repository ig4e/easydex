...
import { NestedEnumMangaPublicationDemographicTypeNullableWithAggregatesFilter } from './nested-enum-manga-publication-demographic-type-nullable-with-aggregates-filter.input';
...
@InputType()
export class EnumMangaPublicationDemographicTypeNullableWithAggregatesFilter {
