...
import { NestedEnumOriginalLanguageTypeNullableWithAggregatesFilter } from './nested-enum-original-language-type-nullable-with-aggregates-filter.input';
...
@InputType()
export class EnumOriginalLanguageTypeNullableWithAggregatesFilter {
