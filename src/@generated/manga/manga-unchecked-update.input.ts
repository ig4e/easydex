...
import { MangaCoverUncheckedUpdateManyWithoutMangaNestedInput } from '../manga-cover/manga-cover-unchecked-update-many-without-manga-nested.input';
...
import { MangaTagUncheckedUpdateManyWithoutMangaNestedInput } from '../manga-tag/manga-tag-unchecked-update-many-without-manga-nested.input';
...
@InputType()
export class MangaUncheckedUpdateInput {

    @Field(() => StringFieldUpdateOperationsInput, {nullable:true})
    dexId?: StringFieldUpdateOperationsInput;

    @Field(() => MangaCoverUncheckedUpdateManyWithoutMangaNestedInput, {nullable:true})
    covers?: MangaCoverUncheckedUpdateManyWithoutMangaNestedInput;
    ...
    @Field(() => MangaTagUncheckedUpdateManyWithoutMangaNestedInput, {nullable:true})
    tags?: MangaTagUncheckedUpdateManyWithoutMangaNestedInput;
